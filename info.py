...
auth_channel = environ.get('AUTH_CHANNEL', '-1002478941535') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002389880858')).split()]
...
REFERAL_PREMEIUM_TIME = environ.get('REFERAL_PREMEIUM_TIME', '2month')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://Tamil_Mob_TY')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/dow_link')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'bnf_bot_disscussion') # Support Chat Link Without https:// or @
